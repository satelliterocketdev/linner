Vue.component ('previously-uploaded', {
    ...
    props: ["title", 'content', 'type', 'update'],
    data() {
        return {
            visible: false,
            contents: {},
    ...
    methods: {
        close() {
            ...
            // $.extend(this.content, null)
            // $.extend(this.content, {})
            // $.extend(this.content, this.tmp)
            // $.extend(this.content, this.selectedItem)
            // Object.assign(this.content, null) // temp
            // Object.assign(this.content, this.selectedItem) // temp
            if (this.selectedItem) {
                this.content.pop()
                this.content.push(this.selectedItem)
                // Object.assign(this.content, this.selectedItem)
            }
