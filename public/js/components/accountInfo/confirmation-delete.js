Vue.component ('confirmation-delete', {
    template: 
    `<div>
    <button type="button" @click="showModal" class="btn mx-1 mb-1 btn-danger font-size-table">{{$t('message.delete')}}</button>
