...
Vue.component('warning-accesstoken', {
  template: 
      ...
      <a-modal :centered="true" v-model="visible" :width="700" :footer="null">
        ...
        <edit-access-token :data="accessToken" :id="id" @update="onUpdate" v-on:closeModal="closeModal()" v-model:loading-count="loadingCountData"></edit-access-token>
      </a-modal>
      </div>`,
    ...
    props: ['accessToken', 'loadingCount', 'id'],
    data() {
        return {
            visible: false,
