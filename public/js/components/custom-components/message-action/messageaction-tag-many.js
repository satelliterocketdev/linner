Vue.component ('messageaction-tags-many', {
    template: 
    `<div>
    ...
    methods: {
        ...
        reloadTag() {
            ...
            this.loadingCount++
            if (this.type == 'New') {
                this.getPath = 'tag/all-account?type='+this.type
            } else {
                this.getPath = 'tag/all-account?type='+this.type+'&account_id='+this.account_id
            }
